...
function Library:Create(table)
    ...
    local themes = {
        Blue = {
            ...
            ContainerBackground = Color3.fromRGB(35, 35, 35),
    ...
    function tabHandler:Tab(name, iconId)
        ...
        function ElementHandler:Section(text)
            ...
            sectionLabel.Size = UDim2.fromOffset(360, 35)
        ...
        function ElementHandler:Label(text)
            ...
            label.Size = UDim2.fromOffset(360, 35)
            label.Parent = holder
            ...
            textLabel.Size = UDim2.fromOffset(350, 35)
        ...
        function ElementHandler:Button(text, callback, iconId)
            ...
            button.Size = UDim2.fromOffset(360, 35)
            button.Text = ""
            ...
            textLabel5.Size = UDim2.fromOffset(320, 35)
        ...
        function ElementHandler:Slider(text, default, min, max, callback)
            ...
            slider.Size = UDim2.fromOffset(360, 35)
            ...
            textLabel1.Size = UDim2.fromOffset(200, 35)
            textLabel1.Parent = slider

            frame.BackgroundColor3 = theme.SliderTrack
            frame.BackgroundTransparency = 0
            frame.Position = UDim2.fromScale(0.62, 0.35)
            frame.Size = UDim2.fromOffset(90, 8)
            frame.Parent = slider
            ...
            frame1.Size = UDim2.fromOffset(((default - min) / (max - min)) * 90, 8)
            frame1.Parent = frame
            ...
            textLabel2.Position = UDim2.fromScale(0.9, 0)
            textLabel2.Size = UDim2.fromOffset(40, 35)
            ...
            UserInputService.InputChanged:Connect(function(input)
                if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                    ...
                    frame1.Size = UDim2.fromOffset(percentage * 90, 8)
        ...
        function ElementHandler:Toggle(text, default, callback)
            ...
            toggle1.Size = UDim2.fromOffset(360, 35)
            toggle1.Text = ""
            ...
            textLabel4.Size = UDim2.fromOffset(320, 35)
        ...
        function ElementHandler:Textbox(text, callback)
            ...
            textbox.Size = UDim2.fromOffset(360, 35)
            ...
            textLabel6.Size = UDim2.fromOffset(280, 35)
            ...
            textBox.Size = UDim2.fromOffset(80, 20)
        ...
        function ElementHandler:Dropdown(text, options, default, callback)
            ...
            dropdown.Size = UDim2.fromOffset(360, 35)
            ...
            dropdownButton.Size = UDim2.fromOffset(360, 35)
            dropdownButton.Text = ""
            ...
            dropdownLabel.Size = UDim2.fromOffset(200, 35)
            ...
            selectedLabel.Size = UDim2.fromOffset(140, 35)
            ...
            dropdownList.Size = UDim2.fromOffset(360, 0)
            ...
            dropdownHolder.Size = UDim2.fromOffset(360, 35)
            ...
            local function updateListSize(opening)
                if opening then
                    ...
                    TweenService:Create(dropdownList, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.fromOffset(360, listHeight)}):Play()
                else
                    TweenService:Create(dropdownList, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {Size = UDim2.fromOffset(360, 0)}):Play()
            ...
            for _, option in ipairs(options) do
                ...
                optionButton.Size = UDim2.fromOffset(360, optionHeight)
                optionButton.Text = ""
                ...
                optionLabel.Position = UDim2.fromScale(0.02, 的基本)
                optionLabel.Size = UDim2.fromOffset(350, optionHeight)
            ...
            local function updateDropdownHolderSize()
                dropdownHolder.Size = UDim2.fromOffset(360, 35 + (isOpen and listHeight or 0))
                updateCanvasSize()
            end
